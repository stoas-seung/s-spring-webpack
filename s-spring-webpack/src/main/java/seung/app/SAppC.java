...
public class SAppC {
	...
	@RequestMapping(value = {"/reflect"}, method = {RequestMethod.GET,RequestMethod.POST})
	...
	@RequestMapping(value = {"/system/config"}, method = {RequestMethod.GET,RequestMethod.POST})
