...
@Configuration
@ComponentScan({"s","seung"})
//@PropertySources({
//	@PropertySource(value="classpath:application.properties")
//	, @PropertySource(value="file:${config.work.path}/ift-worker.properties",ignoreResourceNotFound=true)
//})
...
//			if(propertyName.toLowerCase().matches("(os|computer|user|file|java|spring|server|config).*$")) {
//				configProperties.put(propertyName, properties.getProperty(propertyName));
//			}
//		}
